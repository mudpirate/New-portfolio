...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 md:gap-8 lg:gap-10 mx-auto ",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-3xl border border-white/[0.1] group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none flex flex-col justify-between space-y-4 bg-black/40 ",
        className
      )}
    >
      <div
      ...
      >
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            <div className="absolute z-50 inset-0 flex items-center justify-center text-white font-bold pointer-events-none text-3xl sm:text-4xl md:text-5xl lg:text-7xl text-center"></div>
          </BackgroundGradientAnimation>
        )}
        ...
        >
          ...
          {/* Title */}
          {title && (
            <div className="text-white font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl max-w-full">
              {title}
            </div>
          )}
