      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center justify-center z-10 max-w-4xl w-60 bg-zinc-950 px-3 py-3 ring-1 ring-white/10 "
          >
            <h1 className="relative z-20 text-white text-xs w-48 font-bold inline-block py-0.5">
              {title}
            </h1>
